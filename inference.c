...
// を使用することができる．
    ...
    printf("OK1");
    float * x = load_mnist_bmp("train_00001.bmp");
    init(784*50,0,A1);
    init(50*100,0,A3);
    init(100*10,0,A5);
    init(50,0,b1);
    ...
    init(10,0,b5);
    printf("OK2");
    load("param1SGD.dat", 50, 784, A1, b1);
    printf("OK3");
    load("param3SGD.dat", 100, 50, A3, b3);
    printf("OK4");
    load("param5SGD.dat", 10, 100, A5, b5);
    printf("OK5");
    int ans = inference6(A1, b1, A3, b3, A5, b5, x, y6);
    printf("OK6");
    printf("%d %d\n", ans, 9);
