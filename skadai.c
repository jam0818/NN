        ...
        for (i = 0; i < num_epoch; i++) {
            ...
            for (j = 0; j < num_train; j++) {
                ...
                if(judge == 1){
                    ...
                    //Adamの実行
                    Adam(784, 50, dA1ave, db1ave, A1, b1, m_A1, m_b1, v_A1, v_b1, learning_rate, rho1, rho2, eps, k + 1);
                    Adam(50, 100, dA3ave, db3ave, A3, b3, m_A3, m_b3, v_A3, v_b3, learning_rate, rho1, rho2, eps, k + 1);
                    Adam(100, 10, dA5ave, db5ave, A5, b5, m_A5, m_b5, v_A5, v_b5, learning_rate, rho1, rho2, eps, k + 1);
                } else if (judge == 3) {
                    AdaDelta(784, 50, dA1ave, db1ave, A1, b1, m_A1, m_b1, v_A1, v_b1, rho1, eps);
                    AdaDelta(50, 100, dA3ave, db3ave, A3, b3, m_A3, m_b3, v_A3, v_b3, rho1, eps);
                    AdaDelta(100, 10, dA5ave, db5ave, A5, b5, m_A5, m_b5, v_A5, v_b5, rho1, eps);
                }
